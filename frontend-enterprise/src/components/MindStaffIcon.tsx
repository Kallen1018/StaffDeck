...
type MindStaffIconProps = {
  name: MindStaffIconName;
  className?: string;
  size?: number;
  style?: CSSProperties;
};

const iconPaths: Record<MindStaffIconName, string[]> = {
  arrow: ['M9 5l6 7-6 7'],
...
export default function MindStaffIcon({ name, className = '', size = 18, style }: MindStaffIconProps) {
  return (
    <svg
