    ...
    <div className="min-h-full box-border px-[48px] pt-[32px] pb-[43px] max-[900px]:px-[16px]" aria-busy={loading}>
      ...
      <div className="mt-[20px] mb-[16px] flex items-center justify-end gap-[12px]">
        ...
        {canManageCurrentScope && (
          <DropdownMenu>
            <DropdownMenuTrigger data-guide-target="sop-create" className="flex h-[34px] items-center gap-[4px] rounded-[10px] bg-[#2563EB] px-[20px] text-[12px] font-normal text-white outline-none transition-colors hover:bg-[#1D4ED8]">
